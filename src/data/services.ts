...
export const services: Service[] = [
  {
    ...
    highlights: [
      "IKEA SEKTION cabinet installation",
      "European frameless cabinet systems",
      "Custom cabinet installation",
      "Kitchen and bathroom cabinet replacement",
      "Trim, panels, fillers, and crown molding",
      "Cabinet leveling, alignment, and hardware install",
    ],
    imageSrc: "/images/services/cabinet-installation.jpg",
    imageAlt: "Cabinet installation by NW Premium Design in Seattle",
    icon: "Package",
    ...
    faqs: [
      {
        question: "Is cabinet installation Alex's specialty?",
        answer: "Yes. Cabinet installation is Alex's core specialty, especially projects that need precise layout, leveling, fillers, trim, and finish work.",
      },
      {
        question: "Do you install IKEA cabinets?",
        answer: "Yes. Alex has deep experience with IKEA SEKTION systems and also installs European and custom cabinet lines.",
      },
      {
        question: "Can cabinet installation be a standalone service?",
        answer: "Absolutely. If you've already purchased cabinets and only need a skilled installer, NW Premium Design LLC can handle that as a standalone project.",
      },
      {
        question: "What areas do you serve for cabinet installation?",
        answer: "We serve Seattle, Bellevue, Tacoma, Auburn, Olympia, Graham, Fort Lewis, and the greater Puget Sound area.",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    description: [
      "Your kitchen is the heart of your home, and NW Premium Design LLC handles full kitchen remodels with a cabinet-first mindset. We combine layout improvements, cabinetry, finishes, and installation details into one clean project flow.",
    ...
    imageSrc: "/images/services/kitchen-remodel-9594.jpg",
    ...
    faqs: [
      {
        ...
        answer: "Most kitchen remodels take 2 to 4 weeks depending on scope. A simpler cabinet-focused remodel may move faster, while a full reconfiguration takes longer.",
      },
      {
        question: "Do you handle IKEA kitchen installations?",
        answer: "Yes. Alex specializes in cabinet installation, and that experience carries directly into full kitchen remodel projects.",
      },
      {
        question: "Can you work with cabinets I've already purchased?",
        answer: "Absolutely. Whether you've bought IKEA, custom, or semi-custom cabinets, we can build the rest of the remodel around them.",
      },
      {
        question: "Do you offer free kitchen remodel estimates?",
        answer: "Yes, we provide free in-home estimates for all kitchen remodeling projects across the Seattle and South Sound area.",
      },
    ],
  },
  {
    ...
    description: [
      "Not sure where to buy cabinets, or overwhelmed by the options? NW Premium Design LLC offers a unique cabinet purchasing and supply service, and Alex does the sourcing for you.",
      "We work with IKEA, semi-custom vendors, and custom cabinet makers to find the right fit for your budget and style. You get the cabinets you want, delivered and ready for installation with no stress and no guesswork.",
    ],
    highlights: [
